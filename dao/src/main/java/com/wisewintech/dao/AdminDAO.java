...
public interface AdminDAO {
     ...
     * @return
     */
    int addRoleMenu(@Param("roleId") Integer roleId, @Param("menuIdArr") JSONArray menuIdArr);
     ...
     * @param roleIds 角色id
     */
    boolean delRoleById(@Param("roleIds") JSONArray roleIds);
     ...
     * @return
     */
    boolean delAdminById(@Param("idArr") JSONArray idArr);
     ...
     * @return
     */
    IPage<AdminBO> getAdminByCond(Page page, @Param("map") Map<String, Object> map);
     ...
     * @return
     */
    AdminBO queryAdminBOById(Integer id);
}
